...
export const ClientReceiptDocument: React.FC<ClientReceiptDocumentProps> = ({
    ...
    return (
        <div id="receipt-document" className="p-4 sm:p-8 bg-white border border-slate-200 shadow-xl mx-auto w-full font-sans text-slate-900 print:shadow-none print:border-none print:bg-white print:max-w-none">
