                        ...
                        {stats.teamStats.sort((a, b) => b.eventCount - a.eventCount).map(({ member, eventCount }) => (
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-brand-accent/10 flex items-center justify-center text-brand-accent font-bold text-sm border border-brand-accent/20">
                                        ...
                                        <div className="mt-4 p-4 bg-white/50 rounded-2xl border border-brand-border/40 flex items-center justify-between shadow-sm cursor-pointer hover:bg-white/80 transition-colors" onClick={() => onNavigateToClient && onNavigateToClient(selectedEvent.clientId || '')}>
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 rounded-full bg-brand-accent/10 flex items-center justify-center text-brand-accent font-bold">
                                                    {getInitials(selectedEvent.clientName)}
                                                </div>
                                                <div>
        ...
        <div className="flex h-[calc(100vh-8rem)] bg-brand-surface rounded-2xl overflow-hidden relative">
            ...
            <div className="flex-1 flex flex-row overflow-hidden">
                <div className="flex-1 flex flex-col overflow-y-auto">
                    ...
                    {/* Stat Cards */}
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 border-b border-brand-border/40 bg-brand-bg/30">
                        <StatCard 
                ...
                {selectedTeamMember && (
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-4 p-5 bg-gradient-to-r from-brand-accent/5 to-brand-accent/10 rounded-2xl border border-brand-accent/20">
                            <div className="w-20 h-20 rounded-full bg-brand-accent/20 flex items-center justify-center text-brand-accent font-bold text-3xl border-2 border-brand-accent/30 shadow-lg">
                                    ...
                                    >
                                        <div className="flex items-start justify-between">
                                            <div className="flex items-center gap-3 flex-1">
                                                <div className="w-10 h-10 rounded-full bg-brand-accent/10 flex items-center justify-center text-brand-accent font-bold text-sm border border-brand-accent/20">
                                                    {getInitials(member.name)}
                                                </div>
                                                <div>
