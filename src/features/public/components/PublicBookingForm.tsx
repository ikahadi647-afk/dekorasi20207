            ...
            <div className="flex items-center justify-center min-h-screen p-3 md:p-4">
                <div className="w-full max-w-2xl p-6 md:p-8 text-center bg-public-surface rounded-2xl shadow-lg border border-public-border">
                    ...
                    <div className="space-y-4">
                        <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-black">
                            ...
                            <div className="space-y-5">
                                <h4 className="text-sm md:text-base font-semibold text-gradient border-b border-black pb-2">Informasi Pengantin & Acara Pernikahan</h4>
                                 <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-black">Nama Pengantin Anda atau pasangan</p>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-black">Nomor aktif yang bisa dihubungi</p>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-black">Email untuk konfirmasi dan komunikasi (tidak wajib diisi)</p>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-black">Username Instagram Anda</p>
                                </div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-xs text-black">Pilih jenis Acara Pernikahan</p>
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-xs text-black">Kapan Acara Pernikahan berlangsung? (Opsional)</p>
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-black">Kota tempat Acara Pernikahan berlangsung</p>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-black">Alamat spesifik venue Acara Pernikahan</p>
                                </div>
                            </div>
