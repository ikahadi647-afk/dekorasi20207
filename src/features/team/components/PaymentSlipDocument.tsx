...
export const PaymentSlipDocument: React.FC<PaymentSlipDocumentProps> = ({
    ...
    return (
        <div id={`payment-slip-content-${record.id}`} className="printable-content bg-white font-sans text-slate-900 printable-area max-w-[800px] min-w-[600px] w-full mx-auto">
            {/* Accent Border Top */}
